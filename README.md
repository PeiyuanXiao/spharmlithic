...
spi <- compute_SPI(aligned$d_x, aligned$d_y, aligned$d_z)
...
| Function              | Description                                       |
|:----------------------|:--------------------------------------------------|
| `compute_SPI()`       | Scar Pattern Index                                |
| `compute_spi_angle()` | Scar Pattern Angle                                |
| `compute_EI()`        | Elongation and Isotropy ratio                     |

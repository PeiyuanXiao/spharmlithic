...
Python environment. This is the recommended approach on **macOS**,
where `open3d` can cause R session crashes.
...
For detailed usage, see `vignette("Introduction", package = "spharmlithic")`.
